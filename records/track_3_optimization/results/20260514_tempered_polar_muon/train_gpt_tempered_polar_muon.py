"""
train_gpt_tempered_polar_muon.py
...
tempered polar Muon submission candidate
...
SEED = args.seed
# Fixed submission-candidate defaults. Environment overrides are kept for
# validation sweeps, but the default run is the non-cherry-picked target.
FINAL_TRAIN_STEPS = int(os.environ.get("TRAIN_STEPS", "2985"))
FINAL_SCHEDULE_STEPS = int(os.environ.get("SCHEDULE_STEPS", "3085"))
FINAL_LR_POWER = 1.2
...
FINAL_MUON_WD = 0.025
EXPERIMENT_NAME = "tempered-polar-muon"
...
TEMPERED_POLAR_RHO = float(os.environ.get("TEMPERED_POLAR_RHO", "0.10"))
